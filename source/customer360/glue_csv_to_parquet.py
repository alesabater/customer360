...
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_billing", transformation_ctx = "datasource0")
datasource1 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_contract", transformation_ctx = "datasource1")
datasource2 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_payment", transformation_ctx = "datasource2")
datasource3 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_business_partner", transformation_ctx = "datasource3")
datasource4 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_switch", transformation_ctx = "datasource4")
datasource5 = glueContext.create_dynamic_frame.from_catalog(database = "{u}_landing_db".format(u=username), table_name = "landing_table_consumption_monthly", transformation_ctx = "datasource05")
...
output0 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields0, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_billing".format(u=username)}, format = "parquet", transformation_ctx = "output0")
output1 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields1, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_contract".format(u=username)}, format = "parquet", transformation_ctx = "output1")
output2 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields2, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_payment".format(u=username)}, format = "parquet", transformation_ctx = "output2")
output3 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields3, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_business_partner".format(u=username)}, format = "parquet", transformation_ctx = "output3")
output4 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields4, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_switch".format(u=username)}, format = "parquet", transformation_ctx = "output4")
output5 = glueContext.write_dynamic_frame.from_options(frame = dropnullfields5, connection_type = "s3", connection_options = {"path":"s3://customer360-{u}-trusted-eaberlin/table_consumption_monthly".format(u=username)}, format = "parquet", transformation_ctx = "output5")
